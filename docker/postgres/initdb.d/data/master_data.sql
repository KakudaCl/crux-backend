...
INSERT INTO try_record (gym_id, problem_number, area_id, grade_id, result_id, try_date, day_count) VALUES
    (2, 1, 6, 1, 1, '2025-01-03', 1),
    (2, 2, 5, 1, 1, '2025-01-03', 1),
    (2, 3, 5, 1, 1, '2025-01-03', 1),
    (2, 4, 4, 1, 1, '2025-01-03', 1),
    (2, 5, 1, 1, 1, '2025-01-03', 1),
    (2, 6, 6, 2, 1, '2025-01-03', 1),
    (2, 7, 5, 2, 1, '2025-01-03', 1),
    (2, 9, 4, 2, 1, '2025-01-03', 1),
    (2, 10, 2, 2, 1, '2025-01-03', 1),
    (2, 11, 1, 2, 1, '2025-01-03', 1),
    (2, 13, 5, 3, 1, '2025-01-03', 1),
    (2, 14, 5, 3, 2, '2025-01-03', 1),
    (2, 15, 5, 3, 1, '2025-01-03', 1),
    (2, 17, 2, 3, 2, '2025-01-03', 1),
    (2, 18, 1, 3, 1, '2025-01-03', 1),
    (2, 19, 6, 4, 4, '2025-01-03', 1),
    (2, 20, NULL, 4, 4, '2025-01-03', 1),
    (2, 25, 1, 4, 3, '2025-01-03', 1);
